...
partial class IocSourceGenerator
{
    ...
    private static void WriteDisposalHelperMethods(SourceWriter writer, bool hasAsyncInitServices)
    {
        ...
        if(hasAsyncInitServices)
        {
            ...
            writer.WriteLine("{");
            writer.Indentation++;
            writer.WriteLine("if(task is not null) await DisposeServiceAsync(await task);");
            writer.Indentation--;
            writer.WriteLine("}");
            writer.WriteLine();
            ...
            writer.WriteLine("{");
            writer.Indentation++;
            writer.WriteLine("if(task is not null) DisposeService(task.ConfigureAwait(false).GetAwaiter().GetResult());");
            writer.Indentation--;
            writer.WriteLine("}");
            writer.WriteLine();
        }
