...
SGIOC024 | Usage | Error | InjectMembers specifies non-injectable member - Members in InjectMembers must be injectable (non-static properties with setters, non-readonly non-private fields, or non-private void-returning methods).
