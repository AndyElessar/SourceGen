...
- SGIOC006 - Error - Design - Nested OpenGeneric Detected
...
- SGIOC008 - Error - Usage - Invalid Attribute Usage 
    - Report when `IoCRegisterAttribute` or `IoCRegisterForAttribute` has specify `Factory` or `Instance` and use nameof(), but field/property in nameof() is not static or is inaccessible.
...
- SGIOC100 - Warning - Usage - Duplicated Attribute Usage
