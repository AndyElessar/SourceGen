...
public class IntegrationTests
{
    ...
    public async Task GenerateIocRegisterDefaults_DirectoryWithMatchingFiles_GeneratesOutputFile(CancellationToken ct)
    {
        ...
        fileSystem.AddFile(@"C:\TestDir\Handler1.cs", new MockFileData("public class CommandHandler : IHandler { }"));
        fileSystem.AddFile(@"C:\TestDir\Handler2.cs", new MockFileData("public class QueryHandler : IHandler { }"));
    ...
    public async Task GenerateIocRegisterDefaults_SubDirectories_ProcessesRecursively(CancellationToken ct)
    {
        ...
        fileSystem.AddFile(@"C:\TestDir\Handler1.cs", new MockFileData("public class CommandHandler : IHandler { }"));
        fileSystem.AddFile(@"C:\TestDir\SubDir\Handler2.cs", new MockFileData("public class QueryHandler : IHandler { }"));
    ...
    {
        fileSystem.AddDirectory(@"C:\TestDir");
        fileSystem.AddFile(@"C:\TestDir\Handler.cs", new MockFileData("public class CommandHandler : IHandler { }"));
    ...
    public async Task GenerateIocRegisterDefaults_MaxApplyAcrossFiles_StopsAfterTotalLimit(CancellationToken ct)
    {
        ...
        fileSystem.AddFile(@"C:\TestDir\Handler1.cs", new MockFileData("public class CommandHandler : IHandler { }"));
        fileSystem.AddFile(@"C:\TestDir\Handler2.cs", new MockFileData("public class QueryHandler : IHandler { }"));
        fileSystem.AddFile(@"C:\TestDir\Handler3.cs", new MockFileData("public class EventHandler : IHandler { }"));
    ...
    public async Task GenerateIocRegisterDefaults_FilePattern_FiltersCorrectly(CancellationToken ct)
    {
        fileSystem.AddDirectory(@"C:\TestDir");
        fileSystem.AddFile(@"C:\TestDir\Handler.cs", new MockFileData("public class CommandHandler : IHandler { }"));
        fileSystem.AddFile(@"C:\TestDir\Handler.txt", new MockFileData("public class QueryHandler : IHandler { }"));
    ...
    public async Task GenerateIocRegisterDefaults_IsGenericAttribute_GeneratesGenericSyntax(CancellationToken ct)
    {
        ...
        var content = await fileSystem.File.ReadAllTextAsync(@"C:\TestDir\Generated.cs", ct);
        await Assert.That(content).Contains("[assembly: IocRegisterDefaults<IHandler>");
    }
    ...
    public async Task GenerateIocRegisterDefaults_NotGenericAttribute_GeneratesTypeofSyntax(CancellationToken ct)
    {
        ...
        var content = await fileSystem.File.ReadAllTextAsync(@"C:\TestDir\Generated.cs", ct);
        await Assert.That(content).Contains("[assembly: IocRegisterDefaults(typeof(IHandler)");
    }
