...
> [!TIP]
> If you don't need `KeyType.Csharp`, use `[FromKeyedServices]` instead for better performance, because it avoids factory methods. See [Using `[FromKeyedServices]`](#using-fromkeyedservices).
