...
services.AddSingleton<global::MyNamespace.IExpensiveService, global::MyNamespace.ExpensiveService>();

services.AddSingleton<global::System.Lazy<global::MyNamespace.IExpensiveService>>(
    sp => new global::System.Lazy<global::MyNamespace.IExpensiveService>(
        () => sp.GetRequiredService<global::MyNamespace.IExpensiveService>()));

services.AddSingleton<global::MyNamespace.Consumer>((global::System.IServiceProvider sp) =>
{
    var p0 = sp.GetRequiredService<global::System.Lazy<global::MyNamespace.IExpensiveService>>();
...
services.AddTransient<global::MyNamespace.IWorker, global::MyNamespace.Worker>();

services.AddSingleton<global::System.Func<global::MyNamespace.IWorker>>(
    sp => () => sp.GetRequiredService<global::MyNamespace.IWorker>());

services.AddSingleton<global::MyNamespace.JobRunner>((global::System.IServiceProvider sp) =>
{
    var p0 = sp.GetRequiredService<global::System.Func<global::MyNamespace.IWorker>>();
    var s0 = new global::MyNamespace.JobRunner(p0);
    return s0;
});
```
...
services.AddSingleton<global::MyNamespace.IPlugin, global::MyNamespace.PluginA>();
services.AddSingleton<global::MyNamespace.PluginB, global::MyNamespace.PluginB>();
services.AddSingleton<global::MyNamespace.IPlugin, global::MyNamespace.PluginB>();

services.AddSingleton<global::MyNamespace.PluginHost>((global::System.IServiceProvider sp) =>
{
    var p0 = sp.GetServices<global::MyNamespace.IPlugin>().ToArray();
    var s0 = new global::MyNamespace.PluginHost(p0);
    return s0;
});
```
...
services.AddSingleton<global::MyNamespace.IHandler, global::MyNamespace.HandlerA>();
services.AddSingleton<global::MyNamespace.HandlerB, global::MyNamespace.HandlerB>();
services.AddSingleton<global::MyNamespace.IHandler, global::MyNamespace.HandlerB>();

services.AddSingleton<global::System.Lazy<global::MyNamespace.IHandler>>(
    sp => new global::System.Lazy<global::MyNamespace.IHandler>(
        () => sp.GetRequiredService<global::MyNamespace.HandlerA>()));
services.AddSingleton<global::System.Lazy<global::MyNamespace.IHandler>>(
    sp => new global::System.Lazy<global::MyNamespace.IHandler>(
        () => sp.GetRequiredService<global::MyNamespace.HandlerB>()));

services.AddSingleton<global::MyNamespace.Orchestrator>((global::System.IServiceProvider sp) =>
{
    var p0 = sp.GetServices<global::System.Lazy<global::MyNamespace.IHandler>>();
    var s0 = new global::MyNamespace.Orchestrator(p0);
    return s0;
});
```
...
services.AddSingleton<global::MyNamespace.IRequestHandler<global::MyNamespace.Ping, string>, global::MyNamespace.Handler<global::MyNamespace.Ping, string>>();

// Standalone wrapper registrations
services.AddSingleton<global::System.Lazy<global::MyNamespace.IRequestHandler<global::MyNamespace.Ping, string>>>(
    sp => new global::System.Lazy<global::MyNamespace.IRequestHandler<global::MyNamespace.Ping, string>>(
        () => sp.GetRequiredService<global::MyNamespace.IRequestHandler<global::MyNamespace.Ping, string>>()));
services.AddSingleton<global::System.Func<global::MyNamespace.IRequestHandler<global::MyNamespace.Ping, string>>>(
    sp => () => sp.GetRequiredService<global::MyNamespace.IRequestHandler<global::MyNamespace.Ping, string>>());
```
