...
[assembly: IocRegisterDefaults(typeof(IService), ImplementationTypes = [typeof(MyApp.Services.UserService)])]
```
...
[assembly: IocRegisterDefaults<IService>(ImplementationTypes = [typeof(MyApp.Services.UserService)])]
```
